<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchAdminSettingsModule.ascx.cs" Inherits="Search.Web.Admin.Lite.Controls.SearchAdminSettingsModule" %>
